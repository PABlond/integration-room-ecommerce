...
export const ArrowLeft: FC<{ onClick: () => void }> = ({ ...rest }) => {
  return (
    <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
        d="M13 0L1 12l12 12"
        stroke="#FFF"
        fill="none"
...
export const ArrowRight: FC<{ onClick: () => void }> = ({ ...rest }) => {
  return (
    <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg" {...rest}>
...
export const BigArrow: FC = ({ ...rest }) => {
  return (
    <svg width="40" height="12" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
...
export const Close: FC<{ className: string }> = ({ ...rest }) => {
  return (
...
export const Hamburger: FC = ({ ...rest }) => {
  return (
    <svg width="20" height="14" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
...
export const Logo: FC = ({ ...rest }) => {
  return (
    <svg width="62" height="14" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
